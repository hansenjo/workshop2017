/**************************************************************
  ...
  Updated June 24, 2017 for ROOT6 and analyzer 1.6+
    Must preload libSpectrum.so
    TSpectrum::GetPositionX/Y() returns Double_t*
    New analyzer 1.6 database format - no wire numbers
